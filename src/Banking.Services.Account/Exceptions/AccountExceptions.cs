...
public sealed class AccountNotEligibleForWithdrawalException(string accountId, string reason)
    : Exception($"Account '{accountId}' is not eligible for withdrawal. {reason}");
